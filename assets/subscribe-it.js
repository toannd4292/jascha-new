  ...
  .slider.round:before {
    ...
    SI.Config = {
      ...
      "partials": {},
        ...
        "shop": "jascha-stockholm.myshopify.com",
        ...
        SI.Config.shop = 'jascha-stockholm.myshopify.com';
...
if(SI.Config.isInlineFormEnabled) {
  ...
  @keyframes fade-in-anim-KT {
    ...
    if(SI.Config.isInlineFormEnabled) {
        ...
        link.insertAfter('form[action$="/cart/add"] button[type="submit"]');
